...
import com.victor.module.me.databinding.ActivityMeBinding
import com.victor.module.me.view.fragment.MeFragment
 ...
 * -----------------------------------------------------------------
 */
class MeActivity: BaseActivity<ActivityMeBinding>(ActivityMeBinding::inflate) {
    ...
    override fun onResume() {
        super.onResume()
        switchFragment(currentFragment, MeFragment.newInstance())
    }

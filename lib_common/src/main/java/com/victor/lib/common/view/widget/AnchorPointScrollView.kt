 ...
 * -----------------------------------------------------------------
 * File: AnchorPointScrollView
 * Author: Victor
 * Date: 2023/11/08 10:09
 * Description: 
 * -----------------------------------------------------------------
 */

class AnchorPointScrollView : NestedScrollView,NestedScrollView.OnScrollChangeListener {

    val TAG = "AnchorPointScrollView"

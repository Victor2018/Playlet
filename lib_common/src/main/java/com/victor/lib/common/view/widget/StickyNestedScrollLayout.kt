...
constructor(
    ...
    // 私有类
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private class MyScrollView(val llAdd: LinearLayout) : TabWithScrollView(llAdd.context) {
        /**
         * 请使用[getStickyViews]
         */
     ...
     */
    fun getScrollView(): TabWithScrollView = scrollView

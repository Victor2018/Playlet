...
class H5PayWebView constructor(context: Context, attributeset: AttributeSet) : ConstraintLayout(context, attributeset),
    DownloadListener {

    val TAG = "H5PayWebView"
    ...
    fun loadUrl(url: String) {
        ...
        try {
            ...
            extraHeaders["Referer"] = WebConfig.H5_ONLINE_BASE_URL

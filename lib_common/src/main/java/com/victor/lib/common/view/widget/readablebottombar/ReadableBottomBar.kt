 ...
 * -----------------------------------------------------------------
 * File: ReadableBottomBar
 * Author: Victor
 * Date: 2020/7/13 下午 03:02
 * Description: 
 * -----------------------------------------------------------------
 */
open class ReadableBottomBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)

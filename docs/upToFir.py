...
def upToFir():
	...
	try:
		...
		print ("iconDict = %s" %iconDict)
		print ("binaryDict = %s" %binaryDict)
	...
	try:
		...
		print ("success_apk = %s" %req.content)
	except Exception as e:
		print ("error_apk = %s" %e)
	...
	try:
		...
		print ("success_icon = %s" %req.content)
	except Exception as e:
		print ("error_icon = %s" %e)

package com.victor.module.welfare.view.activity
...
import com.victor.module.welfare.databinding.ActivityWelfareBinding
import com.victor.module.welfare.view.fragment.WelfareFragment
 ...
 * -----------------------------------------------------------------
 */
class WelfareActivity: BaseActivity<ActivityWelfareBinding>(ActivityWelfareBinding::inflate) {
    ...
    override fun onResume() {
        super.onResume()
        switchFragment(currentFragment, WelfareFragment.newInstance())
    }
